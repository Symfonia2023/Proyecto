...
<head>
    ...
    <link rel="stylesheet" href="../../css/login-registro/registro-empresa.css">
                    ...
                    <?php
                        ...
                        ?>
                            <ul class="dropdown-content">
                                ...
                                <li class="dropdown-content-item" id="registroEmpresa"><a href="#">Registro Empresa</a></li>
                            </ul>
                        <?php
                        }
                    ?>
            ...
            <h1>¡Bienvenido!</h1>
                <section class="form-row">
                        <label for="nombre-empresa">
                            ...
                            <input type="text" name="nombre-empresa" id="nombre" placeholder="Nombre Legal de la Empresa" required>
                        </label>
                        <label for="rut">
                            ...
                            <input type="text" name="rut-empresa" id="rut" placeholder="RUT" required>
                        </label>
                        <label for="email">
                            ...
                            <input type="email" name="email-empresa" id="email" placeholder="Email" required>
                        </label>
                        <label for="contraseña">
                            ...
                            <input type="password" name="contraseña-empresa" id="contraseña" placeholder="Contraseña" required>
                        </label>
                        <label for="telefono">
                            ...
                            <input type="text" name="telefono-empresa" id="telefono" placeholder="Telefono" required>
                        </label>
                        <label for="calle">
                            ...
                            <input type="text" name="calle-empresa" id="calle" placeholder="Calle" required>
                        </label>
                        <label for="num-puerta">
                            ...
                            <input type="text" name="numPuerta-empresa" id="num-puerta" placeholder="N° Puerta" required>
                        </label>
                        <label for="esquina">
                            ...
                            <input type="text" name="esquina-empresa" id="esquina" placeholder="Esquina" required>
                        </label>
                        <label for="barrio">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" fill="#6FB85E" class="bi bi-signpost-split-fill" viewBox="0 0 16 16">
                                <path d="M7 16h2V6h5a1 1 0 0 0 .8-.4l.975-1.3a.5.5 0 0 0 0-.6L14.8 2.4A1 1 0 0 0 14 2H9v-.586a1 1 0 0 0-2 0V7H2a1 1 0 0 0-.8.4L.225 8.7a.5.5 0 0 0 0 .6l.975 1.3a1 1 0 0 0 .8.4h5v5z"/>
                        ...
                        <label for="apartamento">
                            ...
                            <input type="text" name="apartamento-empresa" id="apartamento" placeholder="Apartamento">
                        </label>
                        <label for="bloque-apto">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" fill="#6FB85E" class="bi bi-square-fill" viewBox="0 0 16 16">
                                <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z"/>
                            </svg>
                        <input type="text" name="bloqueApto-empresa" id="bloque-apto" placeholder="Bloque">
                        </label>
                </section>
                <label for="btn-registro"><input type="submit" value="Registrarse" id="btn-registro"></label>
                <p style="color: black; padding-bottom: 0.5rem;">¿Tu empresa ya tiene una cuenta?</p>
