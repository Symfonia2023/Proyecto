...
<head>
    ...
    <link rel="icon" href="view/resources/LogoSYMFONIA.png" type="image/png">
...
<body>
    ...
    <nav>
        ...
        <section class="faq-section">
            <p style="padding-bottom: 1.5rem;"> PREGUNTAS FRECUENTES</p>
            <section class="faq-content">
                <section class="faq-item">
                    <h2 class="pregunta">Tuve un problema con mi pedido, ¿Dónde puedo obtener soporte?</h2>
                    <p class="respuesta">
                        Si experimentas algún problema con tu pedido de viandas, puedes obtener soporte de inmediato. Nuestro equipo de atención al cliente está disponible para ayudarte. Puedes comunicarte con 
                        nosotros a través de nuestro número de atención al cliente o enviándonos un correo electrónico a sisviansa@gmail.com.
                    </p>
                </section>
                <section class="faq-item">
                    <h2 class="pregunta">¿Cuáles son los plazos de entrega de las viandas?</h2>
                    <p class="respuesta">
                        Los plazos de entrega varían según tu ubicación y la disponibilidad de los productos. Por lo general, entregamos las viandas dentro de un plazo de 3 a 5 días hábiles desde la fecha de 
                        pedido. Te proporcionaremos una fecha estimada de entrega al realizar tu pedido.
                    </p>
                </section>
                <section class="faq-item">
                    <h2 class="pregunta">¿Ofrecen opciones de viandas para dietas específicas, como vegetarianas o sin gluten?</h2>
                    <p class="respuesta">
                        Sí, ofrecemos una amplia variedad de viandas para adaptarnos a diversas preferencias dietéticas. Tenemos opciones vegetarianas, veganas, sin gluten y otras para satisfacer tus necesidades 
                        específicas. Puedes filtrar las opciones en nuestro sitio web para encontrar las viandas que se ajusten a tu dieta.
                    </p>
                </section>
            </section>
        </section>
