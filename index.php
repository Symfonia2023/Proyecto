...
<head>
    ...
    <link rel="icon" href="view/resources/logo_web.svg" type="image/png">
    <title>Home</title>
</head>
<body>    
    ...
    <nav> 
        <ul>
            <li class="nav-logo"><img src="view/resources/logo_web.svg" width="200px"><p class="nombre-logo">SISVIANSA</p></li>
            ...
            <section>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content">
                        <li class="dropdown-content-item"><a href="view/html/menus/menu-preparado.php">Menús Preparados</a></li>
                    </ul>
                </li>
                <li><a href="view/html/preguntas-frecuentes.php">Preguntas Frecuentes</a></li>    
            </section>
            ...
            <section>
                ...
                <li>
                    <a href="view/html/carrito.php" style="padding: 0.5rem;">
